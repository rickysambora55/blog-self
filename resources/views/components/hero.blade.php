<section class="w-full h-184 px-8 bg-gray-100" id="home">
    <div class="container h-full py-24 flex flex-col md:flex-row gap-8 mx-auto items-center">
        <div class="flex flex-col w-full justify-center text-center md:text-left">
            ...
            <span class="text-6xl font-bold">Uni</span>
            <span class="text-xl">I'am a Fullstack Developer</span>
        </div>
        <div class="flex w-full h-2/3 md:h-full items-center justify-center">

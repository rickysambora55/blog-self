...
<footer id="contact" class="w-full bg-amber-500 text-white py-6">
    <div class="container mx-auto px-6 flex flex-col items-center gap-4">
        ...
        <div class="flex gap-4">
            <!-- GitHub -->
            <x-social-item href="{{$profile['github'] ? 'https://github.com/' . $profile['github'] : '#' }}">
            ...
            <!-- LinkedIn -->
            <x-social-item href="{{$profile['linkedin'] ? 'https://linkedin.com/in/' . $profile['linkedin'] : '#' }}">
                <x-slot:viewBox>0 0 24 24</x-slot:viewBox>
                <path
            ...
            <!-- Instagram -->
            <x-social-item href="{{$profile['instagram'] ? 'https://instagram.com/' . $profile['instagram'] : '#' }}">

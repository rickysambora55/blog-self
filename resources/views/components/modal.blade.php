            ...
            <div @click.stop
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                        <div x-show="modalIcon"
                            class="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full sm:mx-0 sm:size-10"
                            :class="modalIconColor">
                            <i class="fa-solid h-4 w-4 text-lg text-center" :class="modalIconClass"></i>
                        </div>
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            <h3 class="text-base font-semibold text-gray-900" id="modal-title" x-text="modalTitle"></h3>
                            <div class="mt-2">
                ...
                <div class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button :type="modalIsForm ? 'submit' : 'button'" x-on:click="validate() ? modalOn = false : null"
                        class="inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-xs sm:ml-3 sm:w-auto hover:cursor-pointer"
                        :class="modalColor" x-text="modalConfirmText">
                    </button>

    ...
    <body class="overflow-y-scroll" x-data="{ sidebarOn: window.innerWidth >= 640 }"
        ...
        <div class="relative z-50" @click.outside="sidebarOn = false" x-show="sidebarOn || window.innerWidth >= 640"
            ...
            <aside id="sidebar-menu" :class="sidebarOn ? 'translate-x-0' : '-translate-x-full'"
                class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 duration-200 shadow-md"
                aria-label="Sidebar">
                <div
        ...
        <div x-show="sidebarOn" class="bg-gray-900/50 sm:hidden fixed inset-0 z-30"></div>
    </body>
